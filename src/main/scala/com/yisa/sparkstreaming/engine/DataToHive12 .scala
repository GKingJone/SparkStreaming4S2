...
import com.yisa.sparkstreaming.model.PassinfoForHive12
...
object DataToHive12 {
  ...
  def processRdd(rdd: RDD[PassinfoForHive12]): Unit = {
...
//      spark.sql("set hive.exec.dynamic.partition.mode=strict")
      ...
      spark.sql(Config10.HIVE_INSERT_SQL)
  ...
  def main(args: Array[String]) {
    ...
    var sparkConf = new SparkConf().setAppName("DataToHiveDirect")
    ...
    val kafkaParams = Map[String, String](
      ...
      "group.id" -> Config10.KAFKA_GROUP_ID,  
    ...
    messages.foreachRDD(rdd => {
      if (!rdd.isEmpty()) {
        ...
        var aa = rdd.map(line_data => {
          ...
          var inputBean = PassinfoForHive12.apply(passInfo2.id,
