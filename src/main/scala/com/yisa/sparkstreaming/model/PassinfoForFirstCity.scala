 ...
 *
 */
case class PassInfoForFirstCity(
  ...
  //  var vinCode: String, // vin码
  var A037: String,

  //  var realBrandId: String, // 登记的品牌
  var A038: String,
  ...
  var A052: String, // 目前没有做！GPU_WF

  // 1:ALL,0:other
  var isAll: Int ////  var dangerous_chemicals_id : Int,  // 值【0，1】，分别为不是危化品车辆、是危化品车辆
  //  var A046: Int,
  //  
